...
const MenuContentBibimbap = () => {
  return (
    ...
    <h2><img className='sakura' src={sakura}/>BEEF BULGOGI <span className='koreanMenu'>소불고기</span></h2>
    <p>BOEUF MARINÉ : émincé de boeuf tendre longuement mariné dans une sauce bulgogi à base de soja caramélisé, sésame, ail, gingembre et oignons, puis cuit à feu vif.
    </p>
     <h2><img className='sakura' src={sakura}/>CHIKIN POP <span className='koreanMenu'>치킨팝</span> <span className='prix'></span></h2>
    <p>
    POULET FRIT CORÉEN : morceaux de poulet croustillants, marinés dans une sauce soja, ail et gingembre frais, panés, puis frits.
    </p>
    <h2><img className='sakura' src={sakura}/>PORK SSAMJANG <span className='koreanMenu'>돼지고기</span><img className='piment' src={piment}/><img className='piment' src={piment}/></h2>
    <h3>porc mariné</h3>
    <p>
